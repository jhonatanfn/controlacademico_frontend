...
@Component({
  selector: 'app-eliminar-asistencia-auxiliar',
  templateUrl: './eliminar-asistencia-auxiliar.component.html',
  styleUrls: ['./eliminar-asistencia-auxiliar.component.css']
})
export class EliminarAsistenciaAuxiliarComponent implements OnInit {
