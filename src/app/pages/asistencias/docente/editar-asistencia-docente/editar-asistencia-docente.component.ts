...
@Component({
  selector: 'app-editar-asistencia-docente',
  templateUrl: './editar-asistencia-docente.component.html',
  styleUrls: ['./editar-asistencia-docente.component.css']
})
export class EditarAsistenciaDocenteComponent implements OnInit {
  ...
  constructor(
    private asistenciaService: AsistenciaService, private periodoService: PeriodoService,
