...
@Component({
  selector: 'app-crear-asistencia-docente',
  templateUrl: './crear-asistencia-docente.component.html',
  styleUrls: ['./crear-asistencia-docente.component.css']
})
export class CrearAsistenciaDocenteComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private asistenciaService: AsistenciaService, private router: Router,
    ...
    if (this.asisForm.valid) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          this.router.navigateByUrl('dashboard/asistencias/docente');
          Swal.fire({
            position: 'top-end',
            icon: 'success',
