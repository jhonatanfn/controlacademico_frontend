...
@Component({
  selector: 'app-consultar-horario-auxiliar',
  templateUrl: './consultar-horario-auxiliar.component.html',
  styleUrls: ['./consultar-horario-auxiliar.component.css']
})
export class ConsultarHorarioAuxiliarComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    if (this.usuarioService.usuario.role.nombre === "AUXILIAR") {
