...
@Component({
  selector: 'app-lista-material-docente',
  templateUrl: './lista-material-docente.component.html',
  styleUrls: ['./lista-material-docente.component.css']
})
export class ListaMaterialDocenteComponent implements OnInit {
