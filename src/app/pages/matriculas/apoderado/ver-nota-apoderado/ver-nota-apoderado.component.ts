...
@Component({
  selector: 'app-ver-nota-apoderado',
  templateUrl: './ver-nota-apoderado.component.html',
  styleUrls: ['./ver-nota-apoderado.component.css']
})
export class VerNotaApoderadoComponent implements OnInit {
