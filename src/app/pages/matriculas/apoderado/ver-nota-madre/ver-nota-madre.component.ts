...
@Component({
  selector: 'app-ver-nota-madre',
  templateUrl: './ver-nota-madre.component.html',
  styleUrls: ['./ver-nota-madre.component.css']
})
export class VerNotaMadreComponent implements OnInit {
